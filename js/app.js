  ...
  modules: [
    ...
    },
    {
      ...
      cases: [
        ...
        {
          id: "CUS-ORD-05",
          title: "ป้องกันการชำระเงินซ้ำสำหรับคำสั่งซื้อเดียวกัน",
          priority: "med",
          steps:
            "1. ชำระเงินสำหรับคำสั่งซื้อหนึ่งรายการจนสำเร็จ (สถานะเป็น 'ชำระเงินแล้ว')\n2. พยายามเรียกขั้นตอนชำระเงินซ้ำสำหรับคำสั่งซื้อเดียวกันอีกครั้ง (เช่น ผ่านการกดปุ่มย้อนกลับแล้วกดชำระเงินซ้ำ)",
          expected:
            "ระบบปฏิเสธการชำระเงินซ้ำ พร้อมข้อความแจ้งว่าคำสั่งซื้อนี้ชำระเงินไปแล้ว ไม่มีการสร้างรายการชำระเงินซ้ำซ้อน",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      cases: [
        ...
        {
          id: "ADM-ORD-06",
          title: "ยกเลิกคำสั่งซื้อที่ยังไม่ชำระเงิน ไม่ต้องคืนสต็อก",
          priority: "med",
          steps:
            "1. เลือกคำสั่งซื้อที่สถานะ 'รอดำเนินการ'\n2. บันทึกจำนวนสต็อกสินค้าปัจจุบันไว้ก่อน\n3. เปลี่ยนสถานะเป็น 'ยกเลิก'\n4. ตรวจสอบจำนวนสต็อกสินค้าอีกครั้ง",
          expected:
            "จำนวนสต็อกสินค้าต้องไม่เปลี่ยนแปลง เพราะคำสั่งซื้อนี้ยังไม่เคยถูกตัดสต็อกตั้งแต่แรก",
        },
        {
          id: "ADM-ORD-07",
